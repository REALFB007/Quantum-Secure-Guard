...
def generate_report(url, risk, message, findings, fixes, kyber_code, dilithium_code):
    ...
    pdf_path = f"reports/QuantumSecure_{filename}.pdf"
    
    doc = SimpleDocTemplate(pdf_path, pagesize=letter)
    styles = getSampleStyleSheet()
    story = []
    
    story.append(Paragraph("QuantumSecure Report", styles['Title']))
    ...
    story.append(Spacer(1, 20))
    story.append(Paragraph("Generated by QuantumSecureGuard — Prepare for the quantum era", styles['Italic']))
